...
STIN void dradf2(int ido, int l1, const double *cc, double *ch, const double *wa1)
{
	int		 i ;
	int		 k;
	double	 ti2 ;
...
STIN void dradf4(int ido, int l1, const double *cc, double *ch, const double *wa1,
...
STIN void drftf1(int n, double *c, double *ch, double *wa, const int *ifac)
{
	int		 i;
	int		 k1;
	int		 l1;
